...
#define KEY_MAX            XK_x
#define KEY_DOCK_TOGGLE    XK_g
#define KEY_MV_MOUSE_UP    XK_s
#define KEY_MV_MOUSE_LEFT  XK_z
#define KEY_MV_MOUSE_DOWN  XK_d
#define KEY_MV_MOUSE_RIGHT XK_c
#define KEY_CLICK_MOUSE_L  XK_comma
#define KEY_CLICK_MOUSE_R  XK_period
#ifdef VWM
# define KEY_FIX        XK_f
